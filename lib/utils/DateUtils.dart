...
class DateUtils {
  ...
  static DateTime formatFromStringToDateInverted(String date) {
    return DateFormat("dd-MM-yyyy").parse(date);
  }

  static DateTime formatFromStringToDateMinerva(String date) {
  ...
  static String brToBackendDate(String brDate) {
    DateTime date = brToDate(brDate);
    return DateFormat("yyyy-MM-dd").format(date);
  }
